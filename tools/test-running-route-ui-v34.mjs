...
const checks = [
  ...
  ['compact route detail navigation', module.includes("['details','▤'") && module.includes("['photos','▧'")],
  ['map overlay simplified to three metrics', module.includes('gridTemplateColumns: "repeat(3,minmax(0,1fr))"') && module.includes('VOIR LA FICHE')],
