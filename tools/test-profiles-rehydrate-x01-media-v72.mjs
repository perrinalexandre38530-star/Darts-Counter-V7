...
const checks = [
  ...
  ['X01 selected dartset owns a local/recovery media pipeline', (x01.includes('resolveDartSetLocalImageSrc(selectedSet, true)') && x01.includes('selectedVisualSrc')) || (x01.includes('recovery="full"') && dartImage.includes('resolveDartSetRecoveryImageSrc'))],
  ['X01 keeps full media recovery as fallback', x01.includes('resolveDartSetBestImageSrc(selectedSet, true)') || (x01.includes('recovery="full"') && dartImage.includes('allowR2') === false && dartImage.includes('resolveDartSetRecoveryImageSrc'))],
];
