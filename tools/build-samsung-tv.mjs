...
const builtBundle = builtJs
  ...
  .join("\n");
if (!builtBundle.includes("MSS_TV_FULL_APP_BUILD_20260914_03")) {
  console.error("❌ Le bundle Samsung généré ne contient pas TV FULL PREMIUM V3. Build refusé.");
  process.exit(1);
}
console.log("✅ Bundle Samsung TV FULL PREMIUM V3 généré");
