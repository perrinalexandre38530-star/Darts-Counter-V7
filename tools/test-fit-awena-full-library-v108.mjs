...
const checks=[
  ...
  [motion.includes("freeExerciseImageUrl") && motion.indexOf("generatedMedia.videoUrl") < motion.indexOf("referenceImage && referenceImageOk"),"source media are transitional fallbacks after AWENA"],
