...
const checks=[
  ...
  [media.includes("awena-preview.webm")&&media.includes("awena-step-")&&media.includes("/approved"),"deterministic APPROVED AWENA media convention exists"],
  [motion.includes("fitAwenaGeneratedMedia")&&motion.includes("generatedMedia.videoUrl"),"library renderer supports approved generated AWENA video"],
  [motion.includes("freeExerciseImageUrl") && motion.indexOf("generatedMedia.videoUrl") < motion.indexOf("referenceImage && referenceImageOk"),"source media are transitional fallbacks after approved AWENA"],
  [motion.indexOf("knownVideo && knownVideoOk") < motion.indexOf("generatedVideoOk ?"),"hand-authored AWENA media stays authoritative"],
