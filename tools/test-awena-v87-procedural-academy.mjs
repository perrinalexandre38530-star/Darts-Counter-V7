...
must(/LOCAL V8\.[7-9]/.test(overlay) && (overlay.includes("ACADEMY + VOICE X01") || overlay.includes("GUIDE IA PRO + VOICE X01")), "Awena overlay advertises V8.7 Academy or newer");
