...
assert(x01.includes('const x01DartsAll: UIDart[] = React.useMemo('), 'Mémoisation X01 déplacée absente');
...
assert(sw.includes('x01-hooks-hotfix-v17'), 'Service worker hotfix V17 absent');

console.log('OK — X01 hooks stables + cache Historique anti-quota V17');
