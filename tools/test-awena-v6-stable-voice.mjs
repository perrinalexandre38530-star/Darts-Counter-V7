...
must(engine.includes('AudioTrack.MODE_STATIC'), 'Awena V6 must use static full-buffer playback.');
...
must(appGradle.includes('com.github.k2-fsa:sherpa-onnx:v1.13.4'), 'sherpa Android dependency missing.');
