...
const checks = [
  ...
  ['Organization page', (page.includes('MODE ORGANISATION') || page.includes('Bienvenue') || page.includes('Espace organisation')) && page.includes('Équipes & groupes') && page.includes('Agenda')],
