...
export const DARTS_NEW_MODES: DartsModeDef[] = [
  ...
  { id:"halve_it", label:"Halve-It", category:"challenge",
    infoTitle:"HALVE-IT", infoBody:"Contrats successifs : marque uniquement sur la cible demandée. Une volée à 0 touche valide divise ton score par deux. Le plus gros total final gagne.",
    defaultRounds:7, defaultDarts:3 },
  { id:"bobs_27", label:"Bob's 27", category:"training",
    infoTitle:"Bob's 27", infoBody:"Entraînement doubles complet : départ à 27, D1 à D20 puis DBULL. Chaque double cible ajoute sa valeur ; une volée à 0/3 retire cette valeur.",
    defaultRounds:21, defaultDarts:3 },
  ...
  { id:"attrape_moi", label:"Attrape-moi si tu peux !", category:"challenge",
    infoTitle:"ATTRAPE-MOI SI TU PEUX !", infoBody:"Poursuite à score cumulé : le Fuyard démarre avec une avance, le Chasseur doit le rattraper avant la fin des rounds. Les rôles s'inversent après chaque manche ; formats BO3/BO5/BO7 et sets.",
    defaultRounds:10, defaultDarts:3 },
  { id:"president", label:"Président", category:"fun",
    infoTitle:"PRÉSIDENT", infoBody:"Jeu de cartes adapté aux fléchettes : S = carte, D = paire, T = brelan. Plis, hiérarchie Président/Trou du cul, taxes entre manches et variante Chaos.",
    defaultRounds:5, defaultDarts:3 },
  ...
  { id:"shooter", label:"Shooter", category:"training",
    infoTitle:"SHOOTER", infoBody:"Course de précision sur une séquence de cibles. S/D/T rapportent 1/2/3 marks, avec zones imposées, pénalités, score, joueurs, équipes et bots configurables.",
  ...
  { id:"capital", label:"Capital", category:"challenge",
    ...
    defaultRounds:10, defaultDarts:3 },
  { id:"departements", label:"TERRITORIES", category:"fun",
    infoTitle:"TERRITORIES", infoBody:"Mode territorial. Choisis une carte (pays/monde), puis joue les zones.",
    defaultRounds:15, defaultDarts:3 },
  ...
  { id:"prisoner", label:"Prisoner", category:"fun",
    infoTitle:"Prisoner", infoBody:"Course autour du cadran : simples intérieurs/Bull emprisonnent les fléchettes, les zones extérieures permettent de les capturer. Nombre de fléchettes variable et élimination possible.",
