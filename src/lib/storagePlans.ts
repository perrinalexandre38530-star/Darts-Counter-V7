...
export const STORAGE_DESTINATIONS: StorageDestination[] = [
  {
    id: "app_local",
    label: "Mémoire interne de MULTISPORTS SCORING",
    shortLabel: "Mémoire de l'app",
    cloud: false,
    public: true,
    description: "Sauvegarde immédiate dans l'espace privé de l'application. Aucun dossier n'est à choisir, mais cette copie reste liée à cet appareil.",
  },
  {
    id: "device_file",
    label: "Fichier ou dossier choisi par l'utilisateur",
    shortLabel: "Fichier / dossier",
    cloud: false,
    public: true,
    description: "Le sélecteur système choisit l'emplacement exact : mémoire du téléphone, Documents, disque, clé USB ou dossier accessible.",
  },
  {
    id: "external_sd_manual",
    label: "Carte SD / clé USB / disque externe",
    shortLabel: "SD / USB / disque",
    cloud: false,
    public: true,
    description: "Le sélecteur Android ou du navigateur permet de viser un support externe lorsqu'il est exposé par le système.",
    warning: "Si l'accès direct n'est pas proposé par le navigateur, Android ouvre le choix de destination au moment de l'export.",
  },
  {
    id: "personal_cloud_manual",
    label: "Cloud personnel / NAS personnel",
    shortLabel: "Cloud / NAS perso",
    cloud: false,
    public: true,
