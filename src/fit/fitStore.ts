...
export const FIT_EXERCISES: FitExercise[] = [
  { id: "bench", name: "Bench Press", muscle: "Pectoraux", secondary: ["Triceps", "Épaules"], equipment: "Barre", icon: "▰", accent: "#f7c948" },
  { id: "incline-db", name: "Incline Dumbbell Press", muscle: "Pectoraux", secondary: ["Triceps", "Épaules"], equipment: "Haltères", icon: "◩", accent: "#ffcf66" },
  { id: "cable-fly", name: "Cable Fly", muscle: "Pectoraux", equipment: "Poulie", icon: "⌁", accent: "#ffd77a" },
  { id: "pullup", name: "Pull-Up", muscle: "Dos", secondary: ["Biceps"], equipment: "Poids du corps", icon: "⌃", accent: "#76e4f7" },
  { id: "row", name: "Barbell Row", muscle: "Dos", secondary: ["Biceps"], equipment: "Barre", icon: "≋", accent: "#60d5ef" },
  { id: "lat-pulldown", name: "Lat Pulldown", muscle: "Dos", secondary: ["Biceps"], equipment: "Poulie", icon: "⇣", accent: "#56c5e5" },
  { id: "ohp", name: "Overhead Press", muscle: "Épaules", secondary: ["Triceps"], equipment: "Barre", icon: "⇧", accent: "#b59cff" },
  { id: "lateral-raise", name: "Lateral Raise", muscle: "Épaules", equipment: "Haltères", icon: "↔", accent: "#c4adff" },
  { id: "curl", name: "Biceps Curl", muscle: "Biceps", equipment: "Haltères", icon: "◜", accent: "#ff8fb8" },
  { id: "triceps-push", name: "Triceps Pushdown", muscle: "Triceps", equipment: "Poulie", icon: "⇢", accent: "#ff719f" },
  { id: "squat", name: "Squat", muscle: "Quadriceps", secondary: ["Fessiers", "Ischios"], equipment: "Barre", icon: "⌄", accent: "#7df29a" },
  { id: "leg-press", name: "Leg Press", muscle: "Quadriceps", secondary: ["Fessiers"], equipment: "Machine", icon: "◫", accent: "#67e889" },
  { id: "rdl", name: "Romanian Deadlift", muscle: "Ischios", secondary: ["Fessiers", "Dos"], equipment: "Barre", icon: "⌁", accent: "#61d981" },
  { id: "hip-thrust", name: "Hip thrust", muscle: "Fessiers", secondary: ["Ischios"], equipment: "Barre", icon: "◓", accent: "#69eca5" },
  { id: "calf", name: "Standing Calf Raise", muscle: "Mollets", equipment: "Machine", icon: "⌃", accent: "#54d58a" },
  { id: "plank", name: "Plank", muscle: "Abdos", equipment: "Poids du corps", icon: "▬", accent: "#ff9b66" },
  { id: "deadlift", name: "Deadlift", muscle: "Full body", secondary: ["Dos", "Fessiers", "Ischios"], equipment: "Barre", icon: "◆", accent: "#f58d62" },
