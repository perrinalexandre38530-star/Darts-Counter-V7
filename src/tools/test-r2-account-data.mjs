...
const checks = [
  ...
  [cors.includes("capacitor://localhost") && cors.includes('host === "localhost"') && cors.includes("Access-Control-Allow-Origin"), "R2 Pages Function must allow native WebView and localhost dev origins"],
];
