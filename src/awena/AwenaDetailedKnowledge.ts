  ...
  crados: {
    rules: [
      ...
      { title: "CONTAMINER UN SECTEUR LIBRE", bullets: [
        "Un **Simple** dépose **1 couche**, un **Double 2** et un **Triple 3**.",
        "**Prise en main** : un secteur libre ne garde qu'une progression active ; si un autre camp le touche, sa progression devient la nouvelle progression visible.",
        "**Course au secteur** : chaque camp conserve séparément toutes ses touches sur la zone. Le premier qui atteint le seuil configuré remporte le secteur.",
        "En **Course**, lorsque le secteur est gagné, les touches que les autres camps avaient déjà accumulées sur cette zone deviennent autant de **crasse** pour eux.",
        "À **2, 3 ou 4 couches** selon la configuration, le secteur devient CRADO et appartient au camp vainqueur.",
      ] },
      ...
      { title: "BULL PROPRE CONTAGIEUX", body: "Option indépendante : si ton camp est à **0 crasse** au moment de toucher le Bull, un **BULL inflige 1 crasse** à chacun des autres camps encore en jeu et un **DBULL inflige 3 crasses**. Le même tir peut donc devenir offensif lorsque tu es totalement propre." },
      ...
      { title: "LIRE L'ÉCRAN DE JEU", bullets: [
        "Le nom du camp actif est affiché au-dessus du **gros score de crasse**. La frise CRADOS juste dessous visualise l'approche de la limite d'élimination.",
        "Le **mini-radar** ouvre la CARTE DES ZONES en grand.",
        "Première ligne de KPI : **Crasse, Zones, Vols, Darts**.",
        "Le **bandeau joueurs** affiche les médaillons dans l'ordre de jeu et ouvre la liste complète.",
        "Seconde ligne de KPI : **Couches, Lavées, Tours, Manches**.",
        "Le bouton journal à côté du bandeau joueurs ouvre les dernières volées avec avatar, couleur du joueur et code couleur Simple / Double / Triple / Bull / DBull / Miss.",
        "Dans la CARTE DES ZONES, **TOUT** garde tous les joueurs en couleur, **LIBRES** isole les zones non prises et chaque médaillon filtre son joueur / équipe. Cliquer une zone affiche le nombre de touches accumulées par camp sur cette zone ; le Bull est également sélectionnable.",
      ] },
    ...
    configuration: [
      ...
      { title: "BULL PROPRE CONTAGIEUX", body: "Option ON/OFF : à **0 crasse**, un Bull devient offensif contre tous les autres camps. BULL = +1 crasse à chacun ; DBULL = +3 à chacun." },
      { title: "SECTEUR VIERGE", bullets: ["**Prise en main** : la progression visible d'un secteur libre appartient au dernier camp qui l'a touché.", "**Course** : tous les camps conservent leurs touches ; le premier au seuil gagne la zone et les touches adverses sont transformées en crasse."] },
      ...
      { title: "RÉSUMÉ", body: "Avant de démarrer, vérifie participants, ordre, limite de crasse, couches, **Prise en main / Course**, Douche, **Bull propre contagieux**, Blocage / Vol, format et méthode de saisie." },
    ],
  },
