...
const DETAILS: Record<string, AwenaModeConfigDetail> = {
  ...
  gros_6: {
    options: [
      ...
      "règle stricte avec gros simple, petit simple, double et triple distincts, ou règle par valeur",
    ...
    victory: "survivre plus longtemps que les autres : un joueur ou une équipe perd une vie à chaque fois qu'il ne valide pas la cible courante dans sa volée ; le dernier encore en vie gagne. Quand un joueur impose la nouvelle cible, il est sauté tant qu'un autre joueur n'a pas validé une autre cible.",
