...
export const AWENA_VOICE_CATALOG = {
  ...
  crados: {
    intro: "Dans CRADOS, salis les secteurs à ta couleur sans remplir ta jauge de crasse.",
    freeZone: "Cette zone est libre. Simple ajoute une couche, Double deux et Triple trois.",
    ...
    undo: "Le bouton Annuler du keypad efface la saisie en cours. Si la saisie est vide, il annule la dernière volée validée.",
    team: "En équipes, les membres alternent leurs volées et partagent crasse, secteurs, élimination et manches.",
    tip: "Ne cherche pas seulement à posséder des zones. Le vrai équilibre est de gagner du territoire sans offrir ta jauge aux zones adverses.",
    victory: "Le dernier camp non éliminé gagne la manche. Le premier à atteindre le nombre de manches configuré gagne le match.",
  },
  coach: {
