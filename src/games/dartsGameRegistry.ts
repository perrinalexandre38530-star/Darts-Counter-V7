...
const rawDartsGameRegistry: DartsGameDef[] = [
...

  {
    ...
    supportsTeams: false,
    supportsBots: true,
    statsKey: "game:killer_progressive",
    infoTitle: "Killer Progressif",
    infoBody:
      "Chaque joueur obtient un numéro avec un lancer de la main opposée. Touchez votre propre numéro pour monter de 0 à 5 cœurs : simple = 1, double = 2, triple = 3. À 5, le logo KILLER apparaît et vous pouvez retirer des cœurs aux adversaires. Sous 5, le statut KILLER est perdu. À 0 le joueur reste vivant ; il est éliminé seulement sous 0.",
  },
