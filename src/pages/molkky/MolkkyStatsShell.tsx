...
// - Carte 1 : Stats joueur actif (MÖLKKY)
// - Carte 2 : Stats profils locaux (MÖLKKY)
// - Carte 3 : CLASSEMENTS globaux (MÖLKKY)
// - Carte 4 : Historique (MÖLKKY)
...
export default function MolkkyStatsShell({ store, go }: Props) {
  ...
  const molkky = React.useMemo(
    () => computeMolkkySummary((store as any)?.history || []),
    [(store as any)?.history]
  );

  const playerLabel = active
    ? t("statsShell.players.titleActivePrefix","MÖLKKY — STATS ") + active.name
    : t("statsShell.players.titleDefault", "MÖLKKY — STATS");
  ...
  return (
    ...
    >
      ...
      >
        ...
        <StatsShellCard
          title="CLASSEMENTS"
          subtitle="Classements globaux Mölkky (records, victoires, moyennes, etc.)."
          theme={theme}
          onClick={() => go("molkky_stats_leaderboards")}
          onInfo={() => setInfoMode("leaderboards")}
        />

        {/* ✅ ONLINE/TRAINING cachés pour Mölkky */}
        ...
        <StatsShellCard
          ...
          theme={theme}
          onClick={() => go("molkky_stats_history")}
...
function InfoOverlay({
  ...
  switch (mode) {
    case "active":
      title = t("statsShell.info.active.title", "STATS — Joueur actif (Mölkky)");
      body = t(
      ...
      break;
    case "locals":
      title = t("statsShell.info.locals.title", "STATS — Profils locaux (Mölkky)");
      body = t(
      ...
      break;
    case "leaderboards":
      title = t("statsShell.info.leaderboards.title", "CLASSEMENTS (Mölkky)");
      body = t(
      ...
      break;
    case "history":
      title = t("statsShell.info.history.title", "HISTORIQUE (Mölkky)");
      body = t(
