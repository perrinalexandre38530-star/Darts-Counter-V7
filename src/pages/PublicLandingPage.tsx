  ...
  return <main className="mssLanding">
    ...
    <section className="mssAppPreview" aria-label="Aperçu de MULTISPORTS SCORING">
      ...
      <div className="mssDevices">
        <article className="mssDevice mssDeviceLeft"><div className="mssPhone"><div className="mssPhoneBar"><img src={logo} alt=""/><span>CHOISIS TON SPORT</span></div><div className="mssPhoneSports">{sports.slice(0,6).map(([src,n])=><span key={n}><img src={src} alt=""/><b>{n}</b></span>)}</div><div className="mssPhoneNav"><b>JEUX</b><span>PROFILS</span><span>ONLINE</span><span>STATS</span></div></div><strong>22 DISCIPLINES</strong><span>Tout commence au même endroit.</span></article>
        <article className="mssDevice mssDeviceMain"><div className="mssPhone"><div className="mssPhoneBar"><img src={darts} alt=""/><span>X01 • 501</span></div><div className="mssScoreHead"><span>JOUEUR ACTIF</span><b>301</b><small>3 FLÉCHETTES</small></div><div className="mssDartsPad"><span>T20</span><span>20</span><span>D20</span><span>19</span><span>T19</span><span>18</span></div><div className="mssTurn"><span>MOY. 3D <b>67.4</b></span><span>CHECKOUT <b>40</b></span></div><button tabIndex={-1}>VALIDER LE TOUR</button></div><strong>SCORING EN DIRECT</strong><span>Une interface dédiée à chaque mode.</span></article>
        <article className="mssDevice mssDeviceRight"><div className="mssPhone"><div className="mssPhoneBar"><img src={logo} alt=""/><span>MES STATS</span></div><div className="mssPhoneKpis"><span><small>PARTIES</small><b>128</b></span><span><small>VICTOIRES</small><b>74%</b></span></div><div className="mssPhoneChart"><i/><i/><i/><i/><i/><i/></div><div className="mssPhoneRecord"><small>DERNIER RECORD</small><b>+18% DE PROGRESSION</b></div><div className="mssPhoneNav"><span>JEUX</span><span>PROFILS</span><span>ONLINE</span><b>STATS</b></div></div><strong>STATS & PROGRESSION</strong><span>Vos résultats restent exploitables.</span></article>
      </div>
    </section>
