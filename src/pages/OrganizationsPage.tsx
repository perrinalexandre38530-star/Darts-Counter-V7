...
export default function OrganizationsPage({ go, params }: Props) {
  ...
  const renderSection = () => {
    ...
    const generic: Record<Exclude<View, "home" | "profile" | "members" | "groups" | "calendar" | "competitions" | "stats" | "communication" | "federations" | "billing" | "offers">, { title: string; subtitle: string; bullets: string[] }> = {
