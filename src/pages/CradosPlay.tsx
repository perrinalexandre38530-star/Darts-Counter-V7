    ...
    <div style={{ padding: "7px 8px 18px", maxWidth: 980, margin: "0 auto", display: "grid", gap: 8 }}>
      ...
      {state.phase !== "finished" ? <>
        <div style={{ ...panelStyle("rgba(255,255,255,.10)"), padding: 10 }}>
          <div style={{ display: "flex", justifyContent: "space-between", gap: 8, alignItems: "center", marginBottom: 8 }}><div><div style={{ color: ACCENT, fontSize: 10, fontWeight: 1100 }}>CARTE DE CONTAMINATION</div><div style={{ marginTop: 3, color: SOFT, fontSize: 9.5 }}>{config.rules.stealMode === "flip" ? "VOL : attaque les secteurs adverses · +1 crasse/contact" : "BLOCAGE : attention aux secteurs adverses"} · {config.rules.layersToOwn} couches = CRADO</div></div><div style={{ fontSize: 30 }}>🤢</div></div>
