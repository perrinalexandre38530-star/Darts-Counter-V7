...
const INFO_TEXT = `MVP : base jouable (mode fun).`;
...
export default function BatardConfig(props: any) {
  ...
  const payload: BatardConfigPayload = { players, botsEnabled, botLevel, rounds, objective };
  ...
  function start() {
    // App.tsx wiring: tab "batard_play"
    if (props?.setTab) return props.setTab("batard_play", { config: payload });
