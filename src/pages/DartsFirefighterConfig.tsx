...
const HELP_MULTI_INTERVENTION = "Petites cartes uniquement : chaque fléchette numérotée peut agir sur son propre territoire. Exemple S1 + D6 + T4 intervient sur les zones 1, 6 et 4 avec des puissances 1, 2 et 3. Si désactivé, une seule intervention normale est retenue dans la volée ; Bull et DBull restent des actions spéciales séparées.";
