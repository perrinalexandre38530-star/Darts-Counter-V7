...
function TeamsSection({
  ...
  const canAutoShuffleTeams = autoCandidatePlayers.length >= 4;
  ...
  function runAutoTeamShuffle(mode: any) {
    ...
    if (autoSelectedPlayers.length < 4) {
      setAutoShuffleError("Sélectionne au moins 4 joueurs pour créer des équipes aléatoires.");
      return;
    }
