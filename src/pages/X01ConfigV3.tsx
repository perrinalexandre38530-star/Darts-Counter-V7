...
function TeamsSection({
  ...
  const [autoGeneratedTeams, setAutoGeneratedTeams] = React.useState<any[]>(() => loadRememberedGeneratedTeams().filter((team: any) => team?.temporary === true && (team?.allSports === true || String(team?.sport || "darts") === "darts" || (Array.isArray(team?.sportIds) && team.sportIds.map(String).includes("darts")))));
  ...
  }, [autoGeneratedTeams, storedTeams]);
