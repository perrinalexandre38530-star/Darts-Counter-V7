...
const INFO_TEXT = `MVP : base jouable. Version complète : liste cibles/territoires.`;
...
export default function DepartementsConfig(props: any) {
  ...
  const payload: DepartementsConfigPayload = { players, botsEnabled, botLevel, rounds, objective };
  ...
  return (
    <div className="page">
      <PageHeader
        ...
        right={<InfoDot title="Règles DÉPARTEMENTS" content={INFO_TEXT} />}
      />
