...
// Baby-Foot — Menu "Games" (LOCAL ONLY)
// - Aligné sur l'esprit des menus Fléchettes/Pétanque
// =============================================================
...
export default function BabyFootMenuGames({ go }: Props) {
  ...
  return (
    <div style={wrap(theme)}>
      <div style={title(theme)}>BABY-FOOT</div>

      <div style={grid}>
        <button style={card(theme)} onClick={() => go("babyfoot_config")}>
          <div style={cardTitle(theme)}>Jouer</div>
          <div style={cardSub(theme)}>Configurer une partie (score cible, équipes)</div>
        </button>
