...
export type EnculetteConfigPayload = {
  players: number;
  botsEnabled: boolean;
  botLevel: BotLevel;
  rounds: number;
...
const INFO_TEXT = `MVP : base jouable. Version complète : variante Cricket consolidée.`;
...
export default function EnculetteConfig(props: any) {
  ...
  const payload: EnculetteConfigPayload = { players, botsEnabled, botLevel, rounds, objective };
  ...
  function start() {
    // App.tsx wiring: tab "enculette_play"
    if (props?.setTab) return props.setTab("enculette_play", { config: payload });
  ...
  return (
    <div className="page">
      <PageHeader
        ...
        right={<InfoDot title="Règles ENCULETTE / VACHE" content={INFO_TEXT} />}
      />
