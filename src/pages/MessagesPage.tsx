...
function tabButtonStyle(active: boolean, color: string): React.CSSProperties {
  return {
    minHeight: 44,
    borderRadius: 18,
    border: `1px solid ${active ? color : STROKE}`,
    background: active
      ? `linear-gradient(180deg, ${color}2b, rgba(10,10,16,.95))`
      : "linear-gradient(180deg, rgba(255,255,255,.055), rgba(0,0,0,.35))",
    color: active ? color : "#f8f8f8",
    fontWeight: 950,
    fontSize: 13,
    boxShadow: active ? `0 0 16px ${color}55, inset 0 1px 0 ${color}aa` : "inset 0 1px 0 rgba(255,255,255,.08)",
    cursor: "pointer",
    display: "inline-flex",
    alignItems: "center",
