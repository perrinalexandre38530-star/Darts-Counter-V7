  ...
  function buildHistoryRecord(statusOverride?: "in_progress" | "finished") {
    ...
    const playerRows = state.players.map((player, index) => {
      ...
      return {
        ...
        characterId: profile?.characterId ?? player?.characterId ?? null,
        officialCharacter: profile?.officialCharacter ?? player?.officialCharacter ?? false,
        source: profile?.source ?? player?.source ?? null,
        countryCode: profile?.countryCode ?? player?.countryCode ?? null,
        country: profile?.country ?? player?.country ?? null,
        firefighterAiTrait: profile?.firefighterAiTrait ?? player?.firefighterAiTrait ?? null,
        firefighterRole: profile?.firefighterRole ?? player?.firefighterRole ?? null,
        firefighterLevelLabel: profile?.firefighterLevelLabel ?? player?.firefighterLevelLabel ?? null,
