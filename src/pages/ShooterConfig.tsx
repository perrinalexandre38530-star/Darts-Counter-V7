...
export default function ShooterConfig(props: any) {
  ...
  const payload: ShooterConfigPayload = { players, botsEnabled, botLevel, rounds, objective };
  ...
  function start() {
    // App.tsx wiring: tab "shooter_play"
    if (props?.setTab) return props.setTab("shooter_play", { config: payload });
