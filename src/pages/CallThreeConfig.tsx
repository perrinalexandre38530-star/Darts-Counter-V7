...
const rules = <div style={{ display: "grid", gap: 10, fontSize: 13, lineHeight: 1.5 }}>
  ...
  <div><b style={{ color: "#ffb13b" }}>POINTS</b><br/>Simple = 1 point, Double = 2, Triple = 3. Le Bull peut être inclus selon la configuration.</div>
  <div><b style={{ color: "#ff6d3a" }}>VICTOIRE</b><br/>Après le nombre de rounds prévu, le joueur ayant le plus de points gagne.</div>
</div>;
