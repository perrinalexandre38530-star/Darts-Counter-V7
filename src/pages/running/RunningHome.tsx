...
{activitySport === "running" ? <>
    ...
    <div style={{ ...sectionWrap, marginTop: 14 }}><div className="card" style={{ padding: 14 }}><SectionTitle text={copy.start} accent={accent}/>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(2,minmax(0,1fr))", gap: 9 }}>
        <RunAction icon={OUTDOOR_SPORT_PROFILES[activitySport].icon} title={activitySport === "running" ? copy.free : outdoorSportLabel(activitySport, lang).toUpperCase()} subtitle={activitySport === "trail" ? (lang === "fr" ? "GPS · relief · parcours · Ghost" : lang === "es" ? "GPS · relieve · rutas · Ghost" : "GPS · elevation · routes · Ghost") : activitySport === "hiking" ? (lang === "fr" ? "GPS · D+ · temps de mouvement · carte" : lang === "es" ? "GPS · D+ · tiempo en movimiento · mapa" : "GPS · elevation · moving time · map") : copy.freeSub} accent={accent} onClick={() => go("games", presetParams("free", null, activitySport))} featured/>
        <RunAction icon="🌱" title={copy.easy} subtitle={copy.easySub} accent={accent} onClick={() => go("games", presetParams("easy", null, activitySport))}/>
        <RunAction icon={activitySport === "trail" || activitySport === "hiking" ? "⛰️" : "⚡"} title={activitySport === "running" ? copy.intervals : activitySport === "trail" || activitySport === "hiking" ? (lang === "fr" ? "CÔTES" : lang === "es" ? "CUESTAS" : "HILLS") : activitySport === "walking" ? (lang === "fr" ? "MARCHE ACTIVE" : lang === "es" ? "CAMINATA ACTIVA" : "ACTIVE WALK") : (lang === "fr" ? "TECHNIQUE" : lang === "es" ? "TÉCNICA" : "TECHNIQUE")} subtitle={activitySport === "running" ? copy.intervalsSub : (lang === "fr" ? "Relief · cadence · endurance" : lang === "es" ? "Relieve · cadencia · resistencia" : "Elevation · cadence · endurance")} accent={accent} onClick={() => go("games", presetParams(activitySport === "walking" ? "easy" : activitySport === "nordic-walking" ? "tempo" : "hills", null, activitySport))}/>
