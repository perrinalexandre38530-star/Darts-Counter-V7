...
function RouteMap({ points, accent, waiting, showRouteNetwork = false, zoomable = false, immersive = false, route, terrain, onOpen }: {
    points: GeoPoint[];
    accent: string;
    waiting: string;
