...
export default function RunningStatsPage({ go }: Props) {
  ...
  return (
    <div className="container" style={{ maxWidth: 620, paddingBottom: 92 }}>
      ...
      {tab === "connections" ? <RunningSurface accent={accent} active><RunningConnectionsPanel lang={String(lang || "fr")} accent={accent} textSoft={textSoft} onActivitiesChanged={refreshActivities} /></RunningSurface> : null}
