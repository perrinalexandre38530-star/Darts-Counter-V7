...
const INFO_TEXT = `MVP : jeu fun/élimination à affiner. Ici : scoring simple par rounds.`;
...
export default function PrisonerConfig(props: any) {
  ...
  const payload: PrisonerConfigPayload = { players, botsEnabled, botLevel, rounds, objective };
