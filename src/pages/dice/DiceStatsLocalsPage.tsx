// @ts-nocheck
// ============================================
// src/pages/dice/DiceStatsLocalsPage.tsx
...
export default function DiceStatsLocalsPage({ go }: Props) {
    ...
    <div style={pageWrap}>
      ...
      <div style={grid}>
        ...
        <div style={{ ...card, padding: 14 }}>
          <div style={{ fontWeight: 900, marginBottom: 6 }}>{t?.("stats.more") || "Détails"}</div>
        ...
        <div style={{ ...card, padding: 14 }}>
          <div style={{ fontWeight: 900, marginBottom: 6 }}>{t?.("stats.note") || "Note"}</div>
          <div style={{ fontSize: 11, opacity: 0.75 }}>
            {t?.("stats.localsHint") ||
