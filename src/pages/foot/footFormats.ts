...
export const FOOT_FORMATS: FootFormatSpec[] = [
  ...
  { id: "5v5", label: "5V5", icon: "🟢", kind: "team", playersPerSide: 5, periods: 2, minutesPerPeriod: 12, maxPlayersHint: "5 joueurs par équipe", rules: ["Format futsal / city.", "Deux périodes configurables.", "Buts, passes, cartons, CSC."] },
