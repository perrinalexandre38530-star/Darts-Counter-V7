...
export default function BaseballConfig(props: any) {
  ...
  const payload: BaseballConfigPayload = { players, botsEnabled, botLevel, rounds, objective };
  ...
  function start() {
    // App.tsx wiring: tab "baseball_play"
    if (props?.setTab) return props.setTab("baseball_play", { config: payload });
