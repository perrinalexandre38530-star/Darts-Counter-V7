...
import tickerFootball from "../assets-webp/tickers/ticker_football.webp";
...
const INFO_TEXT = `MVP : base jouable. Version complète : points selon zones/combos.`;
...
export default function FootballConfig(props: any) {
  ...
  const payload: FootballConfigPayload = { players, botsEnabled, botLevel, rounds, objective };
  ...
  function start() {
    // App.tsx wiring: tab "football_play"
    if (props?.setTab) return props.setTab("football_play", { config: payload });
  ...
  return (
    <div className="page">
      <PageHeader
        title="FOOT"
        tickerSrc={tickerFootball}
        left={<BackDot onClick={goBack} />}
        right={<InfoDot title="Règles FOOT" content={INFO_TEXT} />}
      />
