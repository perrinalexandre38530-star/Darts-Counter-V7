...
async function buildStatsForProfile(
  ...
  try {
    // SOURCE UNIQUE : StatsBridge lit le même index historique que le centre Stats.
    // Ne pas écraser avec loadX01SamplesForProfile, qui comptait un périmètre X01 différent.
