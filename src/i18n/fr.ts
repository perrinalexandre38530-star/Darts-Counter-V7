...
"home.nav.settings.desc": "Thèmes, langue, reset complet",
  ...
  "settings.audio.startupMusic.off": "Désactivée : accès direct à la sélection des jeux.",
  "settings.audio.startupMusic.note": "OFF supprime entièrement l’écran animé et sa musique au démarrage. L’application arrive directement sur GameSelect. Les sons de jeu, annonces et voix IA restent inchangés.",
