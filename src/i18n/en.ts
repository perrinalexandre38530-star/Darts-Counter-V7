...
export const en: Dict = {
  ...
  "settings.audio.startupMusic.off": "Off: the app opens directly on game selection.",
  "settings.audio.startupMusic.note": "OFF completely skips the animated intro and its music at startup. The app opens directly on GameSelect. Game sounds, announcements and AI voices are unchanged.",
