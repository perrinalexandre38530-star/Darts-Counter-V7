...
const GROUP_ORDER = ["Killer IA", "Loterie IA", "Firefighter IA", "MORVELLOS", "CRADO", "DÉGLINGOS", "GASTROS", "DÉCOMPOSITOS", "GERBOS", "Elite", "Pro", "Challenger", "Mixte", "Rising", "CPU Home"];
