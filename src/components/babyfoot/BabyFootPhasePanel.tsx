  ...
  return (
    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
        <div>
          <div style={{ fontSize: 11, fontWeight: 1000, letterSpacing: 1, color: "rgba(255,255,255,0.64)", textTransform: "uppercase" }}>Contexte</div>
          <div style={{ marginTop: 4, fontSize: 17, fontWeight: 1100 }}>{isPenalties ? "Séance de penalties" : state.phase === "overtime" ? "Prolongation" : "Match en cours"}</div>
        </div>
        <div style={{ display: "inline-flex", alignItems: "center", gap: 8, minHeight: 34, padding: "0 14px", borderRadius: 999, border: "1px solid rgba(199,255,38,0.20)", background: "rgba(199,255,38,0.08)", color: "#eaff84", fontSize: 12, fontWeight: 1100 }}>
          <span style={{ width: 9, height: 9, borderRadius: 999, background: "#9dff57", boxShadow: "0 0 12px rgba(157,255,87,0.46)" }} />
          {statusLabel}
        </div>
      </div>

      <div style={{ marginTop: 10, borderRadius: 14, padding: "10px 12px", border: "1px solid rgba(255,255,255,0.06)", background: "rgba(0,0,0,0.18)" }}>
        <div style={{ fontSize: 10, fontWeight: 1000, letterSpacing: 0.85, color: "rgba(255,255,255,0.60)", textTransform: "uppercase" }}>Dernier but</div>
