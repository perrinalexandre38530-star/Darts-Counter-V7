...
export default function OrganizationCompetitionsPanel({
  ...
  const openDetail = async (competition: OrganizationCompetition) => {
    ...
    try {
      ...
      setDetail(next);
      setScreen("detail");
      setManualHome(""); setManualAway(""); setManualAt("");
