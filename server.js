...
function personalCloudConfigured(provider) {
  const cfg = personalCloudConfig(provider);
  // Les trois fournisseurs utilisent ici un flux OAuth serveur confidentiel.
